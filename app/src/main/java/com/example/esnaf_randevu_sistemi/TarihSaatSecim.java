...
public class TarihSaatSecim extends AppCompatActivity {
    public String secileninId;
    ...
    RecyclerView.Adapter timeSlotAdapter;            //arraydaki her veriyi tek tek listelemek için adapter kullanmamız gerek
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tarih_saat_secim);
        context=TarihSaatSecim.this;
        ...
        Log.d("secilenTarih",secilentarihDBFormat);

        getBerberCalismaSaatleri(secileninId);
    }
    ...
    public void fetchSlotControlData(String docPath, String curDay) { //berberin randevu aralıklarının dolu ve boş olmasını ayarlar
        ...
        db.collection("esnaflar").document(secileninId).collection(curDay)
                .get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            GridLayoutManager gridLayoutManager = new GridLayoutManager(TarihSaatSecim.this, 3); //listeleyeciğimiz array elemanlarının düzenini ayarladık
                            timeSlotAdapter = new TimeSlotAdapter(secileninId,secilentarihDBFormat,secilenTarih,getTimeSet(acilisSaati, kapanisSaati, calismaAralikDk), firebaseData,context); //TimeSlotAdapter isimli adaptor e zaman aralıklarının olduğu array listemizi gönderdik
    ...
    private void initDatePicker() {
        DatePickerDialog.OnDateSetListener dateSetListener = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int yil, int ay, int gun) {  // tarih her değiştiğinde içerisine girer
                ...
                fetchSlotControlData(secileninId, secilentarihDBFormat); //tarih değiştiği için  yeni tarih ile sorguyu yeniden gönderiyorum
            }
        };
        Calendar cal = Calendar.getInstance();
